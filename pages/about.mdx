...
<Card variant='glass' mt={3} p={5} pt={3}>
<Box sx={{fontSize: [4,5,6], color: 'primary_b', mt:3}}>IDB KeyVal</Box>

Local storage using IDB KeyVal to allow users to save progress locally
...
<Card variant='glass' mt={3} p={5} pt={3}>
<Box sx={{fontSize: [4,5,6], color: 'primary_b', mt:3}}>Ace Text Editor</Box>
